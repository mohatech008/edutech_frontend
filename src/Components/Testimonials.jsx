        ...
        <div className="container mx-auto px-6 lg:px-12">
            ...
            <div className="text-center max-w-3xl mx-auto mb-10">
                <h2 className="text-3xl lg:text-4xl font-extrabold text-black mb-4">
                    Read <span className="text-[#2266BE]">Testimonials</span> from Our<br className="hidden md:block"/>
...
<path d="M14.6737 28.3667L13.3337 28.6334V33.3334H15.0003C19.6387 33.3334 23.177 32.0484 25.5153 29.5134C28.6603 26.1001 28.3437 21.7167 28.3337 21.6667V8.33341C28.3337 7.89139 28.1581 7.46746 27.8455 7.1549C27.5329 6.84234 27.109 6.66675 26.667 6.66675H15.0003C13.162 6.66675 11.667 8.16175 11.667 10.0001V21.6667C11.667 22.1088 11.8426 22.5327 12.1551 22.8453C12.4677 23.1578 12.8916 23.3334 13.3337 23.3334H20.1303C20.0944 24.1573 19.8482 24.9582 19.4153 25.6601C18.5703 26.9951 16.9753 27.9051 14.6737 28.3667Z" fill="#FCC21B"/>
</g>
<g clip-path="url(#clip1_42_308)">
<path d="M33.5438 28.3667L32.2038 28.6334V33.3334H33.8704C38.5088 33.3334 42.0471 32.0484 44.3854 29.5134C47.5304 26.1001 47.2138 21.7167 47.2038 21.6667V8.33341C47.2038 7.89139 47.0282 7.46746 46.7156 7.1549C46.4031 6.84234 45.9791 6.66675 45.5371 6.66675H33.8704C32.0321 6.66675 30.5371 8.16175 30.5371 10.0001V21.6667C30.5371 22.1088 30.7127 22.5327 31.0253 22.8453C31.3378 23.1578 31.7617 23.3334 32.2038 23.3334H39.0004C38.9645 24.1573 38.7184 24.9582 38.2854 25.6601C37.4404 26.9951 35.8454 27.9051 33.5438 28.3667Z" fill="#0F1A4F"/>
</g>
<defs>
...
<rect width="37.74" height="40" fill="white" transform="translate(18.8701)"/>
</clipPath>
</defs>
</svg>

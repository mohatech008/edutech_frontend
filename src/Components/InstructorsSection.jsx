                ...
                {mentors.map((mentor)=>(
                    ...
                    className="relative w-36 h-36 sm:w-48 sm:h-48 lg:w-56 lg:h-56 flex items-end justify-center group">
                        ...
                        <img 
                          ...
                          alt={mentor.name}
                          className="relative z-10 w-[85%] h-[85%] object-contain object-bottom group-hover:translate-y-2 transition-transform duration-300" onError={(e)=>{e.target.style.display='none'}}
                          />
                          </div>
                ))}
                </div>

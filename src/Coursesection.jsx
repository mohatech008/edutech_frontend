      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="mb-12 max-w-2xl">
          ...
          <p className="text-gray-500 text-base lg:text-lg leading-relaxed">
            Explore Engaging Lessons, Tailored programs, and Hands-on Learning Experiences that Empower You to Unlock Your Full Potential and Achieve Success in Your Educational Journey.
          </p>
        </div>
        {/*Courses Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {courses.map((course)=>(
            ...
            className="bg-white rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden flex flex-col">
              {/*Card Image Area */}
              <div className={`w-full ${course.bgColor} relative flex items-center justify-center overflow-hidden`}>
                <img
                src={course.image}
                alt={course.title}
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" onError={(e)=>{e.target.style.display='none'}}
                />
                </div>
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  <div className="mt-auto flex justify-between items-center">
                    {/*Tag Pill*/}
                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${course.tagStyle}`}>
                      {course.tag}
                    </span>
                    {/*Rating*/}
